...
import SkillsTag from "./OngoingClubSkillTags";
  ...
  return (
    <div className="ongoing-club-card">
      <div className="ongoing-club-heading">
        ...
        <div className="ongoing-club-deadline">
          {/* <img src="/assets/Time Limit.png" alt="calender" /> */}
          30th July EOD
        </div>
        <div className="ongoing-club-apply-container">
          <Link to={`/${club.club_name.replace(/ /g, "-")}/recruitments`}>
            <button className>Apply Now</button>
          </Link>
        </div>
        <button
          className="club-card-toggle-button"
      ...
      {isOpen && (
        <>
          ...
          <p className="ongoing-club-footer">
            {" "}
            To learn more, click{" "}
            <Link
              className="ongoing-club-page-link"
              to={`/${club.club_name.replace(/ /g, "-")}`}
            >
              here
            </Link>{" "}
